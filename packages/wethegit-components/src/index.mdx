...
Minimally styled, accessible, React component primitives that can be copy and pasted into your project.
...
These components are designed to be a foundation to be extended upon based on your project's requirements. They are meant to speed up work and provide peace of mind knowing that they are accessible and tested.
...
You can also add components by providing the name as an argument:

```bash
npx @wethegit/components-cli add grid-layout flex ...etc
```

Make sure you export the components you just added from your the respective directories `index` files.
...
Your project must have these setup *OR* you can simply do a find/replace and change it.
