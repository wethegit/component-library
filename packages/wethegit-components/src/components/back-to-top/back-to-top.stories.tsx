    ...
    (Story) => (
      ...
      >
        ...
        <Text variant="body-smaller">
          ...
          this component in-situ when contributing.
        </Text>
        <Text variant="body-legal">
          The <code>revealThreshold</code> prop will have no effect within Storybook, as
          the browser's default IntersectionObserver root is <code>window</code>. In
        ...
        <Text variant="body-legal">
          For a similar reason, the "back-to-top" scrolling on this component affects the
          window, not the Story itself. So you will not see anything unless your window is
          scrolled down a bit.
        </Text>
