...
<Meta title="hooks/useAnimatePresence/Readme" />

# useAnimatePresence

useAnimatePresence is a very simple hook that helps you animate components that are added or removed from the DOM.
...
[Story demo](/story/hooks-useanimatepresence--default)
...
[Demo](/story/hooks-useanimatepresence--custom-animation)
...
[Story demo](/story/hooks-useanimatepresence--do-not-animate-on-mount)
